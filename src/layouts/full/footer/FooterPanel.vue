...
const footerLink = shallowRef([
  {
    title: 'Home',
    url: 'https://github.com/HalcyonAlcedo/karin-plugin-manage'
  },
  {
    title: 'Karin',
    url: 'https://karinjs.github.io/Karin/'
  }
]);
</script>
<template>
    ...
    <v-row justify="center" align="center" no-gutters>
      <v-col cols="12" sm="6">
        <p class="text-body-1 mb-0 text-sm-left text-center">
          Karin Manage ♥ crafted by
          <a href="https://github.com/HalcyonAlcedo" class="text-darkText text-decoration-none" target="_blank">Alcedo</a>
        </p>
      </v-col>
